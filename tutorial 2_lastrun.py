...
expName = 'tutorial 2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hp\\Desktop\\PSY310 LAB IN PSYCH\\TUT_2\\tutorial 2_lastrun.py',
